...
function OrderScreen() {
    ...
    const [
        {loading, error, order, loadingPay, successPay }, dispatch,
    ] = useReducer(reducer, {
        loading: true,
        order: {},
        error: '',
    ...
    taxPrice, shippingPrice, totalPrice, isPaid, paidAt, isDelivered,
    deliveredAt} = order;
            ...
            {loading ? (
                ...
                <div className="grid md:grid-cols-4 md:gap-5">
                    <div className="overflow-x-auto md:col-span-3">
                        ...
                        <div className="card p-5">
                            <h2 className="mb-2 text-lg">Paymet Method</h2>
                                <div>
                                    {paymentMethod}
                                </div>
                                {isPaid ? (
